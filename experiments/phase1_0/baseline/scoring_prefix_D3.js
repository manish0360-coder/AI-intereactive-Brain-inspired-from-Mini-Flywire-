// ==========================================================
// PINNED PRE-D3 BASELINE — DO NOT EDIT, DO NOT IMPORT FROM SOURCE
// ==========================================================
// Frozen copy of render/scoring.js as it stood immediately before the
// Phase 1.0 D3 repair (mtime 1780684208109, 15159 bytes).
//
// Purpose: regression comparison only. The module UNDER TEST is always
// imported live from ../../../render/scoring.js. This file is the
// historical reference arm, never a stand-in for it.
// (Guards against the Phase 0 D11 anti-pattern: a harness validating a
//  stale duplicate of the thing it is supposed to be testing.)
// ==========================================================
// ======================================
