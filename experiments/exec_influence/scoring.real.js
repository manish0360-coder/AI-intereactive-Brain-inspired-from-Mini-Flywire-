...
export function calculateDecisionScore({
    ...
    // ── M1 instrumentation: injectable RNG ──
    // Seedable cognitive random source. Defaults to Math.random so
    // omitting it reproduces current behavior exactly (behavior-neutral).
    rng = Math.random,
